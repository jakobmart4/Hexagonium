...
BuildingInfo.Buildings = {
	...
	PowerCore = {
		...
		description = string.format(
			"The heart of your base - only one at a time. Stores up to %d energy (each crystal = %d) for Defenders and repairs buildings within %d hexes - nothing else heals. Upgrade it (right-click) with UP and spare crystal: ALL production up to +%d%%, repair range up to %d. If it falls, bonuses and repairs stop until you build a new one.",
