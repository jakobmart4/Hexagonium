...
local STEP_TEXT = {
	...
	[9] = {
		hint = string.format("Every %d run reward becomes 1 Hex Seed. Your first seed is guaranteed if you Extract after %d+ minutes. Spend seeds in MENU on expansion slots and more cards.", Constants.Meta.SeedsPerPayout, Constants.Meta.MinSeedsRunSeconds // 60),
